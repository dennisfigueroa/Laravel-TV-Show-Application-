            ...
            <div className="collapse navbar-collapse" id="navbarNav" style={{justifyContent:"flex-end"}}>
                ...
                <ul className="navbar-nav">
                    <li className="nav-item active">
                        <a className="nav-link" href="#" style={{marginRight: "100px"}}>Home <span className="sr-only">(current)</span></a>
                    </li>
                    <li className="nav-item">
                        <a className="nav-link" href="#" style={{marginRight: "100px"}}>Login</a>
                    </li>
                    <li className="nav-item">
                        <a className="nav-link" href="#" style={{marginRight: "100px"}}>Register</a>
                    </li>
                </ul>
            </div>
        </nav>
